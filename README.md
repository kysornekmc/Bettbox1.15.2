...
### 💎 深度体验优化
* **开箱即用**：自动化的权限处理与舒适的TUN&VPN体验，预置更加适合中国用户的内核配置，减少繁琐的手动调试/配置为可选非强制
* **精雕细琢**：重新审视打磨每一处细节，稳定无感的轻量模式，移动端更加省电、桌面端更低占用、旨在提供更好的Mihomo客户端体验

### 🛡️ 安全与稳定性
* **安全校验**：遵循Mihomo官方安全建议/内核升级紧跟正式版，桌面端拥有严格的安全校验以及权限控制，有效防范潜在的TOCTOU或非法访问，同时针对常见配置文件错误增加了优雅的回退机制
...
* [Mihomo](https://github.com/MetaCubeX/mihomo) - 强大灵活且易用的代理内核
